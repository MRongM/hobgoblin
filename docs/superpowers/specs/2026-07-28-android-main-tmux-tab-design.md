...
扫描页顶部显示本次选择的主机标题、SSH authority、“更换主机”和“刷新”。“更换主机”直接展开详情内下拉菜单；选择另一台主机后留在扫描态，丢弃旧主机快照并立即扫描，不回到首次选择页。下拉刷新与“刷新”执行同一动作。
...
- **成功空结果**：说明未发现活动会话并提供“重新扫描”；顶部主机下拉保持可用。
- **首次失败**：保留当前主机上下文并显示具体错误和“重试”；顶部主机下拉保持可用。
