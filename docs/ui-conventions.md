...
- Keep destructive batch Git actions at the end of the branch workspace batch-operation group; Batch discard changes is the final batch action before the next menu group.
