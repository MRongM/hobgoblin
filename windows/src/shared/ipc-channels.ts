...
export const RENDERER_BOOTSTRAP_CHANNEL = 'goblin:bootstrap'
...
export const SHELL_PROJECT_WINDOW_CHROME_THEME_CHANNEL = 'goblin:shell-project-window-chrome-theme'
