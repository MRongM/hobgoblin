...
export const zh: Record<DictKey, string> = {
  ...
  'workspace.agents.write-failed': '无法更新 AGENTS.md。',
  'workspace.config.repository-unavailable': '所选仓库必须全部可用。',
  'workspace.batch.create-action': '批量新增工作树',
  'workspace.batch.remove-action': '批量删除工作树',
  'workspace.batch.pull-action': '批量拉取远程',
  'workspace.batch.no-shared-base': '所有仓库没有可共同使用的基准分支。',
  'workspace.batch.no-shared-worktree': '所有仓库没有共有的关联工作树分支。',
  'workspace.worktree.create-title': '新增工作区工作树',
  'workspace.worktree.create-description': '在每个工作区仓库中创建同名分支及关联工作树。',
  'workspace.worktree.remove-title': '删除工作区工作树',
  'workspace.worktree.remove-description': '从每个工作区仓库中删除该分支的关联工作树。',
  'workspace.worktree.remove-warning':
    '将从每个仓库删除工作树。勾选的本地分支会被强制删除，未推送的提交将永久丢失；上游分支仅在勾选后删除。',
  'workspace.worktree.branch-label': '分支名称',
  'workspace.worktree.base-branch-label': '基准分支',
  'workspace.worktree.remove-branch-label': '工作树分支',
  'workspace.worktree.branch-placeholder': 'feature/my-change',
  'workspace.worktree.creates-from': '由此创建',
  'workspace.worktree.remove-linked-worktree': '删除关联工作树',
  'workspace.worktree.always': '必定执行',
  'workspace.worktree.repositories-count': '{count} 个仓库',
  'workspace.worktree.pull-title': '批量拉取工作区仓库',
  'workspace.worktree.pull-description': '依次快进拉取每个工作区仓库当前分支。',
  'workspace.worktree.preview': '预览变更',
  'workspace.worktree.check-repositories': '检查仓库',
  'workspace.worktree.planning': '正在检查仓库…',
  'workspace.worktree.repository': '仓库',
  'workspace.worktree.path': '工作树路径',
  'workspace.worktree.status': '状态',
  'workspace.worktree.bootstrap-copy': '初始化将复制 {count} 个路径',
  'workspace.worktree.phase.ready': '就绪',
  'workspace.worktree.phase.satisfied': '已满足',
  'workspace.worktree.phase.succeeded': '成功',
  'workspace.worktree.phase.failed': '失败',
  'workspace.worktree.phase.not-started': '未开始',
  'workspace.worktree.cancel': '取消',
  'workspace.worktree.create-confirm': '在全部仓库中新增',
  'workspace.worktree.remove-confirm': '从全部仓库中删除',
  'workspace.worktree.pull-confirm': '拉取全部仓库',
  'workspace.worktree.create-success': '已在所有仓库中新增工作树。',
  'workspace.worktree.remove-success': '已从所有仓库中删除工作树。',
  'workspace.worktree.pull-success': '已拉取所有仓库。',
  'workspace.worktree.batch-incomplete': '批量操作未全部完成。',
  'workspace.worktree.retry': '重试剩余仓库',
  'workspace.worktree.invalid-branch': '请输入有效的 Git 分支名称。',
  'workspace.worktree.repository-unavailable': '有工作区仓库不可用。',
  'workspace.worktree.branch-exists': '该分支已存在于某个工作区仓库中。',
  'workspace.worktree.path-exists': '计划使用的工作树路径已存在。',
  'workspace.worktree.base-unavailable': '某个仓库没有可用的基准分支。',
  'workspace.worktree.target-missing': '某个仓库不存在对应的关联工作树。',
  'workspace.worktree.pull-target-unavailable': '某个仓库没有可拉取的根工作树分支。',
  'workspace.worktree.remove-unsafe': '工作树为主工作树、包含改动或已锁定，无法删除。',
  'workspace.worktree.plan-stale': '仓库状态已变化，请检查刷新后的计划。',
  'workspace.worktree.plan-failed': '无法创建工作区工作树计划。',
  'workspace.worktree.execute-failed': '无法完成工作区工作树操作。',
  'workspace.worktree.operation-in-progress': '已有其他工作区工作树操作正在运行。',
  'workspace.worktree.bootstrap-confirmation-required': '请检查并确认仓库初始化操作。',
