...
export const ja: Record<DictKey, string> = {
  ...
  'menu.file.open-wsl-project': 'WSL プロジェクトを開く…',
  ...
  'workspace.branch-workspace.sync-before-create-select-all': '選択した同期可能なリポジトリをすべて作成前に同期',
  ...
  'worktree-bootstrap.source-detached': 'detached worktree {head} の依存項目を使用しています。',
  ...
  'worktree-dependency-tree.loading': '依存ディレクトリを読み込み中…',
  'worktree-dependency-tree.error': 'このディレクトリを読み込めません。',
  'worktree-dependency-tree.retry': '再試行',
  'worktree-dependency-tree.empty': 'このディレクトリは空です。',
  'worktree-dependency-tree.expand': '{path} を展開',
  'worktree-dependency-tree.collapse': '{path} を折りたたむ',
  'worktree-dependency-tree.select': '{path} を選択',
  'worktree-dependency-tree.mode': '{path} の依存方法',
  'worktree-dependency-tree.symlink': 'シンボリックリンク',
  'worktree-dependency-tree.copy': 'コピー',
  'worktree-dependency-tree.symlink-disabled': 'シンボリックリンクは選択できません。',
  ...
  'workspace.branch-workspace.dependency.recheck': '再確認',
  'workspace.branch-workspace.dependency.recheck-required':
    '一部の依存項目の変更が完了したか、プランが変更されました。続行する前に残りの作業を再確認してください。',
  ...
  'workspace.branch-workspace.one-step.incomplete': '選択を完了すると、操作プランが表示されます。',
  'workspace.branch-workspace.one-step.planning': '操作プランを更新中…',
  ...
  'workspace.branch-workspace.git-action.remove-upstream': '上流を削除',
  'workspace.branch-workspace.git-action.remove-upstream-selected': '上流を削除するよう選択済み',
  ...
  'workspace.branch-workspace.git-action.progress': '一括操作の進行状況',
  ...
  'workspace.branch-workspace.force-delete': '強制削除',
  'workspace.branch-workspace.force-delete-description':
    '先にブランチワークスペースのフォルダーとアプリ設定を削除し、その後メンバー worktree の登録をクリーンアップします。',
  ...
  'workspace.branch-workspace.force-delete-cleanup-warning':
    'ブランチワークスペースは強制削除されましたが、{count} 件のメンバー worktree 登録をクリーンアップできませんでした。',
  ...
  'repo-tabs.open-wsl': 'WSL プロジェクトを開く…',
  ...
  'repo-tabs.open-source-label': 'プロジェクトシステム',
  'repo-tabs.open-source-local': 'Windows / ローカル',
  'repo-tabs.open-source-wsl': 'WSL',
  'repo-tabs.open-wsl-distribution-label': 'WSL ディストリビューション',
  'repo-tabs.open-wsl-distribution-placeholder': 'Ubuntu',
  'repo-tabs.open-wsl-path-label': 'Linux プロジェクトパス',
  'repo-tabs.open-wsl-path-placeholder': '/home/user/src/project',
  'repo-tabs.open-wsl-title': 'WSL プロジェクトを開く',
  'repo-tabs.open-wsl-description':
    'WSL ディストリビューションを選択し、Linux の絶対パスを入力して、Git リポジトリまたはマルチリポジトリワークスペースを新しいタブで開きます。',
  'repo-tabs.open-wsl-confirm': 'WSL プロジェクトを開く',
  'error.wsl-unavailable': 'WSL を利用できないか、登録済みのディストリビューションがありません。',
  'error.wsl-distribution-unavailable': '選択した WSL ディストリビューションは利用できません。',
  ...
  'terminal.command-deck.focus': 'フォーカス',
  'terminal.command-deck.exit-focus': 'フォーカスを終了',
  ...
  'action.checkout-to-remote-loading': 'リモートブランチを読み込み中…',
  'action.checkout-to-remote-empty': '利用できるリモートブランチはありません。',
  'action.checkout-to-remote-load-failed': 'リモートブランチを読み込めませんでした。ローカルブランチは選択できます。',
  ...
  'action.branch-upstream-set': '上流ブランチを設定',
  'action.branch-upstream-change': '上流ブランチを変更',
  'action.branch-upstream-title': '{branch} の上流を管理',
  'action.branch-upstream-current': '現在の上流',
  'action.branch-upstream-gone': '見つかりません',
  'action.branch-upstream-remote-label': '上流ブランチ',
  'action.branch-upstream-remote-placeholder': 'リモートブランチを選択',
  'action.branch-upstream-loading': 'リモートブランチを読み込んでいます…',
  'action.branch-upstream-empty': '一致するリモートブランチがありません。',
  'action.branch-upstream-load-error': 'リモートブランチを読み込めませんでした。',
  'action.branch-upstream-remove': '上流を解除',
  'action.branch-upstream-confirm': '上流を更新',
  'action.branch-upstream-updating': '上流を更新しています…',
  'action.branch-upstream-queued': '上流の更新を待機しています…',
  'action.branch-upstream-updated': '上流を更新しました',
  ...
  'error.repository-changed':
    'ブランチ、ワークツリー、upstream、またはローカル変更が更新されました。確認して再試行してください。',
  ...
  'error.upstream-shared': 'この上流は別のローカルブランチでも使用されているため、削除しませんでした。',
  ...
  'settings.telegram.terminal-input-enabled': 'Telegram からのターミナル入力を許可',
  ...
  'settings.telegram.terminal-input-status.stopped': '停止',
  'settings.telegram.terminal-input-status.starting': '開始中',
  ...
  'telegram.terminal-input.reply.expired': 'メッセージが古いため、ターミナルへ送信しませんでした。',
  'telegram.terminal-input.reply.invalid': '空でない1行のプレーンテキストのみ送信できます。',
  'telegram.terminal-input.reply.write-failed': 'ターミナル入力に失敗し、メッセージを送信しませんでした。',
  ...
  'settings.telegram.error.terminal-input-configuration-incomplete':
    'ターミナル入力には Bot Token、数値グループ Chat ID、有効なユーザー ID が必要です。',
  ...
  'settings.terminal.windows-external': '外部ターミナル',
  'settings.terminal.auto-windows': '自動（WSL 優先）',
  ...
  'settings.apps.tool.cmd.title': 'コマンド プロンプト',
  ...
  'settings.general.open-app-config-action': '設定ディレクトリを開く',
  'settings.general.open-app-config-failed': 'アプリケーション設定を開けませんでした',
  ...
  'help.hint': 'ショートカットはアクティブな画面でのみ動作し、ターミナル用を除いてテキスト入力中は実行されません。',
  'help.section.nav': 'ナビゲーション',
  'help.section.terminal': 'ターミナル',
