...
export const ja: Record<DictKey, string> = {
  ...
  'workspace.batch.pull-action': 'すべてのリポジトリを pull',
  'workspace.batch.no-shared-base': '共通のベースブランチがありません。',
  'workspace.batch.no-shared-worktree': 'すべてのリポジトリに共通する worktree ブランチがありません。',
  'workspace.worktree.create-title': 'ワークスペース worktree を作成',
  'workspace.worktree.create-description': 'すべてのワークスペースリポジトリに同名ブランチと worktree を作成します。',
  'workspace.worktree.remove-title': 'ワークスペース worktree を削除',
  'workspace.worktree.remove-description':
    'すべてのワークスペースリポジトリから、このブランチの worktree を削除します。',
  'workspace.worktree.remove-warning':
    '各 worktree を削除します。選択したローカルブランチは強制削除され、未 push のコミットは完全に失われます。Upstream ブランチは選択した場合のみ削除されます。',
  'workspace.worktree.branch-label': 'ブランチ名',
  'workspace.worktree.base-branch-label': 'ベースブランチ',
  'workspace.worktree.remove-branch-label': 'Worktree ブランチ',
  'workspace.worktree.branch-placeholder': 'feature/my-change',
  'workspace.worktree.creates-from': 'ここから作成',
  'workspace.worktree.remove-linked-worktree': 'リンク済み worktree を削除',
  'workspace.worktree.always': '常に実行',
  'workspace.worktree.repositories-count': '{count} 件のリポジトリ',
  'workspace.worktree.pull-title': 'ワークスペースリポジトリを pull',
  'workspace.worktree.pull-description': '各ワークスペースリポジトリの現在のブランチを fast-forward pull します。',
  'workspace.worktree.preview': '変更をプレビュー',
  'workspace.worktree.check-repositories': 'リポジトリを確認',
  'workspace.worktree.planning': 'リポジトリを確認中…',
  'workspace.worktree.repository': 'リポジトリ',
  'workspace.worktree.path': 'Worktree パス',
  'workspace.worktree.status': 'ステータス',
  'workspace.worktree.bootstrap-copy': 'Bootstrap で {count} 個のパスをコピー',
  'workspace.worktree.phase.ready': '準備完了',
  'workspace.worktree.phase.satisfied': '確認済み',
  'workspace.worktree.phase.succeeded': '成功',
  'workspace.worktree.phase.failed': '失敗',
  'workspace.worktree.phase.not-started': '未開始',
  'workspace.worktree.cancel': 'キャンセル',
  'workspace.worktree.create-confirm': 'すべてのリポジトリに作成',
  'workspace.worktree.remove-confirm': 'すべてのリポジトリから削除',
  'workspace.worktree.pull-confirm': 'すべてのリポジトリを pull',
  'workspace.worktree.create-success': 'すべてのリポジトリに worktree を作成しました。',
  'workspace.worktree.remove-success': 'すべてのリポジトリから worktree を削除しました。',
  'workspace.worktree.pull-success': 'すべてのリポジトリを pull しました。',
  'workspace.worktree.batch-incomplete': 'ワークスペースの一括操作を完了できませんでした。',
  'workspace.worktree.retry': '残りを再試行',
  'workspace.worktree.invalid-branch': '有効な Git ブランチ名を入力してください。',
  'workspace.worktree.repository-unavailable': 'ワークスペースリポジトリを利用できません。',
  'workspace.worktree.branch-exists': 'ブランチがワークスペースリポジトリに既に存在します。',
  'workspace.worktree.path-exists': '予定された worktree パスが既に存在します。',
  'workspace.worktree.base-unavailable': '利用可能なベースブランチがないリポジトリがあります。',
  'workspace.worktree.target-missing': '対応する worktree がないリポジトリがあります。',
  'workspace.worktree.pull-target-unavailable': 'pull できるルート worktree ブランチがないリポジトリがあります。',
  'workspace.worktree.remove-unsafe': 'プライマリ、変更あり、またはロック中の worktree は削除できません。',
  'workspace.worktree.plan-stale': 'リポジトリの状態が変わりました。更新された計画を確認してください。',
  'workspace.worktree.plan-failed': 'ワークスペース worktree の計画を作成できませんでした。',
  'workspace.worktree.execute-failed': 'ワークスペース worktree 操作を完了できませんでした。',
  'workspace.worktree.operation-in-progress': '別のワークスペース worktree 操作が実行中です。',
  'workspace.worktree.bootstrap-confirmation-required': 'リポジトリの bootstrap 操作を確認してください。',
