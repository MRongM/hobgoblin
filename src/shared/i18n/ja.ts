...
export const ja: Record<DictKey, string> = {
  ...
  'settings.proxy.git-body': 'ローカル Git ネットワーク操作のプロキシとタイムアウトを設定します。',
  'settings.proxy.git-proxy': 'Git ネットワークプロキシ',
  'settings.proxy.git-proxy-hint': 'ローカルリポジトリの fetch、pull、push、clone にのみ適用されます。',
  'settings.proxy.git-proxy-url': 'プロキシ URL',
  'settings.proxy.git-proxy-url-hint': 'http://、https://、socks5:// URL をサポートします。',
