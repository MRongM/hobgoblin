...
export const ja: Record<DictKey, string> = {
  ...
  'tmux.host-inventory.none': 'このホストに検証済みの Hobgoblin tmux セッションはありません。',
  ...
  'tmux.host-inventory.description': 'このホストで閉じる検証済み Hobgoblin セッションを選択します。',
  'tmux.host-inventory.select-session': 'tmux セッション {name} を選択',
  'tmux.host-inventory.terminal-number': 'ターミナル {number}',
  'tmux.host-inventory.project-root': 'プロジェクト',
  ...
  'action.merge-and-push-confirm': 'プル・マージ・プッシュ',
