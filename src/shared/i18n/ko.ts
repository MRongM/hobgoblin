...
export const ko: Record<DictKey, string> = {
  ...
  'workspace.repositories.collapse': '워크스페이스 저장소 접기',
  'workspace.repositories.expand': '워크스페이스 저장소 펼치기',
  ...
  'workspace.branch-workspace.auxiliary': '추가 파일 및 폴더',
  'workspace.branch-workspace.auxiliary-refresh': '추가 파일 및 폴더 새로 고침',
  'workspace.branch-workspace.auxiliary-named': '추가 항목 {name} 포함',
  'workspace.branch-workspace.mode-named': '{name}의 배치 방식',
  'workspace.branch-workspace.auxiliary-empty': '선택할 수 있는 추가 항목이 없습니다.',
  ...
  'workspace.branch-workspace.git-action.merge-back-description':
    '각 현재 브랜치를 기록된 기준 브랜치로 순서대로 병합합니다.',
  ...
  'workspace.branch-workspace.delete-warning':
    '관리되는 작업 트리와 이 폴더를 제거합니다. 외부 터미널은 감지할 수 없습니다.',
  ...
  'branch-detail.focus': '최대화',
  'branch-detail.focus-title': '최대화',
  'branch-detail.exit-focus': '최소화',
  'branch-detail.exit-focus-title': '최소화',
