...
export const ko: Record<DictKey, string> = {
  ...
  'tmux.host-inventory.none': '이 호스트에서 검증된 Hobgoblin tmux 세션을 찾지 못했습니다.',
  ...
  'tmux.host-inventory.description': '이 호스트에서 닫을 검증된 Hobgoblin 세션을 선택하세요.',
  'tmux.host-inventory.select-session': 'tmux 세션 {name} 선택',
  'tmux.host-inventory.terminal-number': '터미널 {number}',
  'tmux.host-inventory.project-root': '프로젝트',
  ...
  'action.merge-and-push-confirm': '풀·병합·푸시',
