...
export const ko: Record<DictKey, string> = {
  ...
  'menu.file.open-wsl-project': 'WSL 프로젝트 열기…',
  ...
  'workspace.branch-workspace.sync-before-create-select-all': '선택한 동기화 가능 저장소를 모두 생성 전에 동기화',
  ...
  'workspace.branch-workspace.dependency.recheck': '다시 확인',
  'workspace.branch-workspace.dependency.recheck-required':
    '일부 의존 항목 변경이 완료되었거나 계획이 변경되었습니다. 계속하기 전에 남은 작업을 다시 확인하세요.',
  ...
  'workspace.branch-workspace.one-step.incomplete': '선택을 완료하면 작업 계획이 표시됩니다.',
  'workspace.branch-workspace.one-step.planning': '작업 계획을 업데이트하는 중…',
  ...
  'workspace.branch-workspace.force-delete': '강제 삭제',
  'workspace.branch-workspace.force-delete-description':
    '브랜치 워크스페이스 폴더와 앱 구성을 먼저 삭제한 다음 멤버 워크트리 등록 정리를 시도합니다.',
  ...
  'workspace.branch-workspace.force-delete-cleanup-warning':
    '브랜치 워크스페이스는 강제 삭제되었지만 멤버 워크트리 등록 {count}개를 정리하지 못했습니다.',
  ...
  'repo-tabs.open-wsl': 'WSL 프로젝트 열기…',
  ...
  'repo-tabs.open-source-label': '프로젝트 시스템',
  'repo-tabs.open-source-local': 'Windows / 로컬',
  'repo-tabs.open-source-wsl': 'WSL',
  'repo-tabs.open-wsl-distribution-label': 'WSL 배포판',
  'repo-tabs.open-wsl-distribution-placeholder': 'Ubuntu',
  'repo-tabs.open-wsl-path-label': 'Linux 프로젝트 경로',
  'repo-tabs.open-wsl-path-placeholder': '/home/user/src/project',
  'repo-tabs.open-wsl-title': 'WSL 프로젝트 열기',
  'repo-tabs.open-wsl-description':
    'WSL 배포판을 선택하고 절대 Linux 경로를 입력하여 Git 리포지토리 또는 다중 리포지토리 워크스페이스를 새 탭으로 엽니다.',
  'repo-tabs.open-wsl-confirm': 'WSL 프로젝트 열기',
  'error.wsl-unavailable': 'WSL을 사용할 수 없거나 등록된 배포판이 없습니다.',
  'error.wsl-distribution-unavailable': '선택한 WSL 배포판을 사용할 수 없습니다.',
  ...
  'action.checkout-to-remote-loading': '원격 브랜치를 불러오는 중…',
  'action.checkout-to-remote-empty': '사용 가능한 원격 브랜치가 없습니다.',
  'action.checkout-to-remote-load-failed': '원격 브랜치를 불러올 수 없습니다. 로컬 브랜치는 선택할 수 있습니다.',
  ...
  'action.merge-out-source-conflicted': '내보내기 전에 소스 작업 트리의 충돌을 해결하거나 현재 병합을 중단하세요.',
  'action.merge-out-source-unavailable': '소스 작업 트리 상태를 읽을 수 없습니다.',
  ...
  'action.merge-conflict-ai-copy-prompt': '프롬프트 복사',
  'action.merge-conflict-ai-prompt-copied': '프롬프트 복사됨',
  ...
  'error.merge-out-source-conflicted': '내보내기 전에 소스 작업 트리의 충돌을 해결하거나 현재 병합을 중단하세요.',
  ...
  'error.windows-internal-terminal-wsl-unavailable': '내부 터미널에서 WSL을 사용할 수 없습니다',
  'error.windows-internal-terminal-powershell-unavailable': '내부 터미널에서 PowerShell을 사용할 수 없습니다',
  'error.windows-internal-terminal-cmd-unavailable': '내부 터미널에서 명령 프롬프트를 사용할 수 없습니다',
  ...
  'settings.telegram.terminal-input-enabled': 'Telegram 터미널 입력 허용',
  'settings.telegram.terminal-input-enabled-hint':
    '허용된 그룹 사용자가 Bot을 멘션하여 마지막으로 포커스된 제어 터미널에 한 줄을 보낼 수 있습니다.',
  'settings.telegram.terminal-input-user-ids': '허용된 사용자 ID',
  'settings.telegram.terminal-input-user-ids-hint': '숫자 Telegram 사용자 ID 1~32개를 쉼표나 공백으로 구분하세요.',
  'settings.telegram.terminal-input-poll-timeout': '롱 폴링 대기',
  'settings.telegram.terminal-input-poll-timeout-hint': 'Telegram이 메시지를 기다린 뒤 요청을 갱신하는 시간입니다.',
  'settings.telegram.poll-seconds': '초',
  'settings.telegram.terminal-input-status': '폴링 상태',
  'settings.telegram.terminal-input-status-hint': '서버 Telegram 수신기의 현재 상태입니다.',
  'settings.telegram.terminal-input-status.stopped': '중지됨',
  'settings.telegram.terminal-input-status.starting': '시작 중',
  'settings.telegram.terminal-input-status.running': '실행 중',
  'settings.telegram.terminal-input-status.retrying': '재시도 중',
  'settings.telegram.terminal-input-status.error': '설정 오류',
  'settings.telegram.terminal-input-error.configuration-incomplete':
    'Bot Token, 숫자 그룹 Chat ID 또는 사용자 ID가 없습니다.',
  'settings.telegram.terminal-input-error.authentication-failed': 'Telegram이 Bot Token을 거부했습니다.',
  'settings.telegram.terminal-input-error.invalid-chat': '설정한 Chat ID가 대상 그룹이 아닙니다.',
  'settings.telegram.terminal-input-error.webhook-conflict': 'Webhook이 설정되어 있어 롱 폴링을 시작할 수 없습니다.',
  'settings.telegram.terminal-input-error.network-failed': 'Telegram에 일시적으로 연결할 수 없어 자동 재시도합니다.',
  'settings.telegram.terminal-input-error.telegram-rejected': 'Telegram이 폴링 요청을 거부했습니다.',
  'telegram.terminal-input.reply.unauthorized': '터미널 입력을 사용할 권한이 없습니다.',
  'telegram.terminal-input.reply.expired': '메시지가 너무 오래되어 터미널로 보내지 않았습니다.',
  'telegram.terminal-input.reply.invalid': '비어 있지 않은 한 줄의 일반 텍스트만 보낼 수 있습니다.',
  'telegram.terminal-input.reply.write-failed': '터미널 입력에 실패하여 메시지를 보내지 않았습니다.',
  'telegram.terminal-input.reply.no-target': '현재 포커스되고 제어권이 있는 터미널이 없습니다.',
  'telegram.terminal-input.reply.target-lost': '터미널 대상이 변경되어 메시지를 보내지 않았습니다.',
  'telegram.terminal-input.reply.success': '터미널로 전송했습니다',
  'settings.telegram.master-off-hint': '터미널 벨 알림은 꺼져 있습니다. Telegram 터미널 입력에는 영향을 주지 않습니다.',
  ...
  'settings.telegram.error.terminal-input-configuration-incomplete':
    '터미널 입력에는 Bot Token, 숫자 그룹 Chat ID, 유효한 사용자 ID가 필요합니다.',
  ...
  'settings.macos-permissions.title': 'macOS 시스템 권한',
  'settings.macos-permissions.hint': 'Codex가 Hobgoblin 터미널에서 Computer Use를 사용할 때 필요한 권한입니다.',
  'settings.macos-permissions.screen-recording': '화면 기록',
  'settings.macos-permissions.screen-recording-hint': 'Computer Use가 앱 창과 화면 내용을 볼 수 있도록 허용합니다.',
  'settings.macos-permissions.accessibility': '손쉬운 사용',
  'settings.macos-permissions.accessibility-hint':
    'Computer Use가 앱에서 클릭하고 입력하고 탐색할 수 있도록 허용합니다.',
  'settings.macos-permissions.status.not-determined': '요청하지 않음',
  'settings.macos-permissions.status.granted': '허용됨',
  'settings.macos-permissions.status.denied': '허용되지 않음',
  'settings.macos-permissions.status.restricted': '제한됨',
  'settings.macos-permissions.status.unknown': '알 수 없음',
  'settings.macos-permissions.status.unsupported': '지원되지 않음',
  'settings.macos-permissions.authorize': '권한 허용',
  'settings.macos-permissions.open-system-settings': '시스템 설정 열기',
  'settings.macos-permissions.requesting': '여는 중…',
  'settings.macos-permissions.request-failed': 'macOS 권한 설정을 열 수 없습니다',
  'settings.macos-permissions.restart-hint':
    '권한을 변경한 뒤에도 Computer Use가 앱을 보거나 제어할 수 없다면 Hobgoblin을 다시 시작하세요.',
  ...
  'settings.terminal.windows-external': '외부 터미널',
  'settings.terminal.auto-windows': '자동(WSL 우선)',
  'settings.terminal.wsl': 'WSL',
  'settings.terminal.powershell': 'PowerShell',
  'settings.terminal.cmd': '명령 프롬프트',
  'settings.windows-internal-terminal-shell.title': 'Windows 내부 터미널',
  'settings.windows-internal-terminal-shell.label': '셸',
  'settings.windows-internal-terminal-shell.hint':
    '새로 만들거나 다시 시작한 로컬 Windows 내부 터미널에 적용됩니다. 프로젝트의 Git 실행 환경은 변경되지 않습니다.',
  'settings.windows-internal-terminal-shell.auto': '자동(WSL 우선)',
  'settings.windows-internal-terminal-shell.wsl': 'WSL',
  'settings.windows-internal-terminal-shell.powershell': 'PowerShell',
  'settings.windows-internal-terminal-shell.cmd': '명령 프롬프트',
  ...
  'settings.apps.tool.cmd.title': '명령 프롬프트',
