...
export const ko: Record<DictKey, string> = {
  ...
  'settings.proxy.git-body': '로컬 Git 네트워크 작업의 프록시와 시간 초과를 설정합니다.',
  'settings.proxy.git-proxy': 'Git 네트워크 프록시',
  'settings.proxy.git-proxy-hint': '로컬 저장소의 fetch, pull, push, clone에만 적용됩니다.',
  'settings.proxy.git-proxy-url': '프록시 URL',
  'settings.proxy.git-proxy-url-hint': 'http://, https://, socks5:// URL을 지원합니다.',
