...
export const ko: Record<DictKey, string> = {
  ...
  'workspace.batch.pull-action': '모든 저장소 풀',
  'workspace.batch.no-shared-base': '공통 기준 브랜치를 사용할 수 없습니다.',
  'workspace.batch.no-shared-worktree': '모든 저장소에 공통 작업 트리 브랜치가 없습니다.',
  'workspace.worktree.create-title': '워크스페이스 작업 트리 만들기',
  'workspace.worktree.create-description': '모든 워크스페이스 저장소에 같은 이름의 브랜치와 작업 트리를 만듭니다.',
  'workspace.worktree.remove-title': '워크스페이스 작업 트리 제거',
  'workspace.worktree.remove-description': '모든 워크스페이스 저장소에서 이 브랜치의 작업 트리를 제거합니다.',
  'workspace.worktree.remove-warning':
    '각 작업 트리를 제거합니다. 선택한 로컬 브랜치는 강제로 삭제되며 푸시하지 않은 커밋은 영구적으로 손실됩니다. 업스트림 브랜치는 선택한 경우에만 삭제됩니다.',
  'workspace.worktree.branch-label': '브랜치 이름',
  'workspace.worktree.base-branch-label': '기준 브랜치',
  'workspace.worktree.remove-branch-label': '작업 트리 브랜치',
  'workspace.worktree.branch-placeholder': 'feature/my-change',
  'workspace.worktree.creates-from': '여기에서 생성',
  'workspace.worktree.remove-linked-worktree': '연결된 작업 트리 제거',
  'workspace.worktree.always': '항상 실행',
  'workspace.worktree.repositories-count': '저장소 {count}개',
  'workspace.worktree.pull-title': '워크스페이스 저장소 풀',
  'workspace.worktree.pull-description': '각 워크스페이스 저장소의 현재 브랜치를 fast-forward로 풉니다.',
  'workspace.worktree.preview': '변경 사항 미리 보기',
  'workspace.worktree.check-repositories': '저장소 확인',
  'workspace.worktree.planning': '저장소 확인 중…',
  'workspace.worktree.repository': '저장소',
  'workspace.worktree.path': '작업 트리 경로',
  'workspace.worktree.status': '상태',
  'workspace.worktree.bootstrap-copy': 'Bootstrap에서 {count}개 경로 복사',
  'workspace.worktree.phase.ready': '준비됨',
  'workspace.worktree.phase.satisfied': '충족됨',
  'workspace.worktree.phase.succeeded': '성공',
  'workspace.worktree.phase.failed': '실패',
  'workspace.worktree.phase.not-started': '시작 안 함',
  'workspace.worktree.cancel': '취소',
  'workspace.worktree.create-confirm': '모든 저장소에 만들기',
  'workspace.worktree.remove-confirm': '모든 저장소에서 제거',
  'workspace.worktree.pull-confirm': '모든 저장소 풀',
  'workspace.worktree.create-success': '모든 저장소에 작업 트리를 만들었습니다.',
  'workspace.worktree.remove-success': '모든 저장소에서 작업 트리를 제거했습니다.',
  'workspace.worktree.pull-success': '모든 저장소를 풀했습니다.',
  'workspace.worktree.batch-incomplete': '워크스페이스 일괄 작업을 완료하지 못했습니다.',
  'workspace.worktree.retry': '남은 항목 다시 시도',
  'workspace.worktree.invalid-branch': '올바른 Git 브랜치 이름을 입력하세요.',
  'workspace.worktree.repository-unavailable': '워크스페이스 저장소를 사용할 수 없습니다.',
  'workspace.worktree.branch-exists': '브랜치가 워크스페이스 저장소에 이미 존재합니다.',
  'workspace.worktree.path-exists': '예정된 작업 트리 경로가 이미 존재합니다.',
  'workspace.worktree.base-unavailable': '사용할 수 있는 기준 브랜치가 없는 저장소가 있습니다.',
  'workspace.worktree.target-missing': '연결된 작업 트리가 없는 저장소가 있습니다.',
  'workspace.worktree.pull-target-unavailable': '풀할 루트 작업 트리 브랜치가 없는 저장소가 있습니다.',
  'workspace.worktree.remove-unsafe': '기본, 변경됨 또는 잠긴 작업 트리는 제거할 수 없습니다.',
  'workspace.worktree.plan-stale': '저장소 상태가 변경되었습니다. 새로 고친 계획을 검토하세요.',
  'workspace.worktree.plan-failed': '워크스페이스 작업 트리 계획을 만들 수 없습니다.',
  'workspace.worktree.execute-failed': '워크스페이스 작업 트리 작업을 완료할 수 없습니다.',
  'workspace.worktree.operation-in-progress': '다른 워크스페이스 작업 트리 작업이 실행 중입니다.',
  'workspace.worktree.bootstrap-confirmation-required': '저장소 bootstrap 작업을 검토하고 확인하세요.',
