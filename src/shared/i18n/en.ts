...
export const en = {
  ...
  'menu.file.open-wsl-project': 'Open WSL Project…',
  ...
  'workspace.branch-workspace.creation-base-remote': 'Remote branches',
  'workspace.branch-workspace.sync-before-create': 'Sync before creation',
  'workspace.branch-workspace.sync-before-create-select-all': 'Sync all eligible selected repositories before creation',
  'workspace.branch-workspace.sync-before-create-named': 'Sync {name} before creation',
  'workspace.branch-workspace.sync-no-upstream':
    'No usable remote upstream; creation will use the current local branch.',
  'workspace.branch-workspace.existing-target-used': 'The existing target branch {branch} will be used.',
  'workspace.branch-workspace.remote-branches-loading': 'Loading remote branches…',
  'workspace.branch-workspace.remote-branches-error': 'Remote branches could not be loaded.',
  'workspace.branch-workspace.preview-source-local': 'Local branch {ref}',
  'workspace.branch-workspace.preview-source-remote': 'Remote branch {ref}',
  'workspace.branch-workspace.preview-source-existing-target': 'Existing target branch {ref}',
  'workspace.branch-workspace.preview-sync-enabled': 'Sync before creation',
  'workspace.branch-workspace.preview-sync-disabled': 'No sync before creation',
  'workspace.branch-workspace.repository-dependencies-toggle': 'Dependencies',
  'workspace.branch-workspace.repository-dependencies-toggle-named': 'Select repository dependencies for {name}',
  ...
  'workspace.branch-workspace.repository-dependencies-error':
    "Repository dependencies could not be loaded; turn this repository's dependency switch off and on to retry.",
  ...
  'worktree-bootstrap.source-primary': 'Using dependencies from the primary worktree.',
  'worktree-bootstrap.source-branch': 'Using dependencies from {branch}.',
  'worktree-bootstrap.source-detached': 'Using dependencies from detached worktree {head}.',
  'worktree-bootstrap.source-select': 'Use dependencies from another worktree',
  'worktree-bootstrap.source-primary-option': 'Primary worktree',
  'worktree-bootstrap.source-detached-option': 'Detached ({head})',
  'worktree-dependency-tree.loading': 'Loading dependencies…',
  'worktree-dependency-tree.error': 'Could not load this directory.',
  'worktree-dependency-tree.retry': 'Retry',
  'worktree-dependency-tree.empty': 'This directory is empty.',
  'worktree-dependency-tree.expand': 'Expand {path}',
  'worktree-dependency-tree.collapse': 'Collapse {path}',
  'worktree-dependency-tree.select': 'Select {path}',
  'worktree-dependency-tree.mode': 'Dependency mode for {path}',
  'worktree-dependency-tree.symlink': 'Symlink',
  'worktree-dependency-tree.copy': 'Copy',
  'worktree-dependency-tree.symlink-disabled': 'Symbolic links cannot be selected.',
  ...
  'workspace.branch-workspace.dependency.recheck': 'Recheck',
  'workspace.branch-workspace.dependency.recheck-required':
    'Some dependency changes were completed or the plan changed. Recheck the remaining work before continuing.',
  ...
  'workspace.branch-workspace.one-step.incomplete': 'Complete the selection to review the operation plan.',
  'workspace.branch-workspace.one-step.planning': 'Updating the operation plan…',
  ...
  'workspace.branch-workspace.progress.summary': 'Completed {completed}/{total}',
  'workspace.branch-workspace.progress.pending': 'Waiting',
  'workspace.branch-workspace.progress.active': 'In progress',
  'workspace.branch-workspace.progress.complete': 'Complete',
  'workspace.branch-workspace.progress.failed': 'Failed',
  ...
  'workspace.branch-workspace.git-action.remove-upstream': 'Remove upstream',
  'workspace.branch-workspace.git-action.remove-upstream-selected': 'Marked to remove upstream',
  ...
  'workspace.branch-workspace.git-action.progress': 'Batch operation progress',
  'workspace.branch-workspace.git-action.source-branch': 'Source branch for {repository}',
  'workspace.branch-workspace.git-action.select-source': 'Select source',
  'workspace.branch-workspace.git-action.source-branch-required': 'Select a source branch.',
  ...
  'workspace.branch-workspace.git-action.merge-out': 'Merge out',
  'workspace.branch-workspace.git-action.pull-merge-out-push': 'Pull destination, merge out & push',
  ...
  'workspace.branch-workspace.git-action.members-failed': 'Some repository members failed. Review the summary below.',
  'workspace.branch-workspace.git-action.member-failure-summary': 'Member errors ({count})',
  'workspace.branch-workspace.git-action.member-failure-ai-handoff': 'Hand errors off to AI',
  ...
  'workspace.branch-workspace.force-delete': 'Force delete',
  'workspace.branch-workspace.force-delete-description':
    'Delete the branch workspace folder and application record first, then try to clean up member worktree records.',
  ...
  'workspace.branch-workspace.force-delete-cleanup-warning':
    '{count} member worktree records could not be cleaned after the branch workspace was force-deleted.',
  ...
  'repo-tabs.open-wsl': 'Open WSL project…',
  ...
  'repo-tabs.open-source-label': 'Project system',
  'repo-tabs.open-source-local': 'Windows / local',
  'repo-tabs.open-source-wsl': 'WSL',
  'repo-tabs.open-wsl-distribution-label': 'WSL distribution',
  'repo-tabs.open-wsl-distribution-placeholder': 'Ubuntu',
  'repo-tabs.open-wsl-path-label': 'Linux project path',
  'repo-tabs.open-wsl-path-placeholder': '/home/user/src/project',
  'repo-tabs.open-wsl-title': 'Open WSL project',
  'repo-tabs.open-wsl-description':
    'Select a WSL distribution and enter an absolute Linux path to open a Git repository or multi-repository workspace as a new tab.',
  'repo-tabs.open-wsl-confirm': 'Open WSL project',
  'error.wsl-unavailable': 'WSL is unavailable or has no registered distribution.',
  'error.wsl-distribution-unavailable': 'The selected WSL distribution is unavailable.',
  ...
  'tmux.host-inventory.action': 'Scan host tmux sessions',
  'tmux.host-inventory.none': 'No manageable tmux sessions were found on this host.',
  'tmux.host-inventory.preview-failed': 'Failed to scan tmux sessions on this host.',
  'tmux.host-inventory.execute-failed': 'Failed to close the selected tmux sessions.',
  'tmux.host-inventory.title': 'Host tmux sessions',
  'tmux.host-inventory.description': 'Inspect sessions in an external terminal or select sessions to close.',
  'tmux.host-inventory.select-session': 'Select tmux session {name}',
  'tmux.host-inventory.terminal-number': 'Terminal {number}',
  'tmux.host-inventory.default-session': 'Default server session',
  'tmux.host-inventory.open-external': 'Open tmux session {name} in an external terminal',
  'tmux.host-inventory.open-failed': 'Failed to open the tmux session in an external terminal.',
  'tmux.host-inventory.open-missing': 'This tmux session no longer exists.',
  'tmux.host-inventory.detached': 'detached',
  'tmux.host-inventory.attached': '{count} attached',
  'tmux.host-inventory.warning':
    'Closing a session ends its running processes and immediately disconnects every attached client.',
  'tmux.host-inventory.close-selected': 'Close selected sessions ({count})',
  'tmux.host-inventory.partial': 'Closed {closed}; {failed} failed; {missing} no longer existed.',
  'tmux.host-inventory.success': 'Closed {count} tmux session(s).',
  'tmux.host-inventory.missing': '{count} selected session(s) had already ended.',
  ...
  'terminal.command-deck.hide-compose': 'Hide composer',
  ...
  'terminal.command-deck.exit-focus': 'Exit focus',
  ...
  'action.checkout-to-remote-loading': 'Loading remote branches…',
  'action.checkout-to-remote-empty': 'No remote branches are available.',
  'action.checkout-to-remote-load-failed': 'Remote branches could not be loaded. Local branches remain available.',
  'action.merge-in': 'Merge into this branch',
  'action.merge-in-title': 'Merge another branch into {branch}',
  'action.merge-in-label': 'Source branch',
  ...
  'action.merge-out-remote-push-note':
    'The remote target will be fetched, merged in a temporary worktree, and pushed exactly.',
  ...
  'action.branch-upstream-set': 'Set upstream branch',
  'action.branch-upstream-change': 'Change upstream branch',
  'action.branch-upstream-title': 'Manage upstream for {branch}',
  'action.branch-upstream-current': 'Current upstream',
  'action.branch-upstream-gone': 'gone',
  'action.branch-upstream-remote-label': 'Upstream branch',
  'action.branch-upstream-remote-placeholder': 'Select a remote branch',
  'action.branch-upstream-loading': 'Loading remote branches…',
  'action.branch-upstream-empty': 'No matching remote branches.',
  'action.branch-upstream-load-error': 'Failed to load remote branches.',
  'action.branch-upstream-remove': 'Remove upstream',
  'action.branch-upstream-confirm': 'Update upstream',
  'action.branch-upstream-updating': 'Updating upstream…',
  'action.branch-upstream-queued': 'Waiting to update upstream…',
  'action.branch-upstream-updated': 'Updated upstream',
  ...
  'action.create-worktree-sync-before-create': 'Sync before creation',
  'action.create-worktree-sync-no-upstream': 'No usable remote upstream; creation will use the current local branch.',
  ...
  'error.merge-out-destination-changed': 'The destination branch changed. Review the refreshed plan and try again.',
  ...
  'error.tmux-invalid-socket-directory': 'The tmux socket directory could not be inspected safely.',
  ...
  'error.worktree-sync-unavailable': 'The worktree creation source could not be synchronized.',
  ...
  'error.windows-internal-terminal-wsl-unavailable': 'WSL is unavailable for internal terminals',
  'error.windows-internal-terminal-powershell-unavailable': 'PowerShell is unavailable for internal terminals',
  'error.windows-internal-terminal-cmd-unavailable': 'Command Prompt is unavailable for internal terminals',
  ...
  'error.upstream-shared': 'The upstream is also used by another local branch and was not deleted.',
  ...
  'settings.telegram.terminal-input-enabled': 'Allow Telegram terminal input',
  'settings.telegram.terminal-input-enabled-hint':
    'Let authorized group members send one line to the most recently focused controlling terminal by mentioning the bot.',
  'settings.telegram.terminal-input-user-ids': 'Authorized user IDs',
  'settings.telegram.terminal-input-user-ids-hint':
    'Enter 1–32 numeric Telegram user IDs, separated by commas or spaces.',
  'settings.telegram.terminal-input-poll-timeout': 'Long-poll wait',
  'settings.telegram.terminal-input-poll-timeout-hint':
    'Telegram waits this long for messages before the server renews the request.',
  'settings.telegram.poll-seconds': 'seconds',
  'settings.telegram.terminal-input-status': 'Polling status',
  'settings.telegram.terminal-input-status-hint': 'Current server-owned Telegram receiver state.',
  'settings.telegram.terminal-input-status.stopped': 'Stopped',
  'settings.telegram.terminal-input-status.starting': 'Starting',
  'settings.telegram.terminal-input-status.running': 'Running',
  'settings.telegram.terminal-input-status.retrying': 'Retrying',
  'settings.telegram.terminal-input-status.error': 'Configuration error',
  'settings.telegram.terminal-input-error.configuration-incomplete':
    'Bot Token, numeric group Chat ID, or user IDs are missing.',
  'settings.telegram.terminal-input-error.authentication-failed': 'Telegram rejected the Bot Token.',
  'settings.telegram.terminal-input-error.invalid-chat': 'The configured Chat ID is not the expected group.',
  'settings.telegram.terminal-input-error.webhook-conflict':
    'This bot has a webhook configured, so long polling cannot start.',
  'settings.telegram.terminal-input-error.network-failed': 'Telegram is temporarily unreachable; polling will retry.',
  'settings.telegram.terminal-input-error.telegram-rejected': 'Telegram rejected the polling request.',
  'telegram.terminal-input.reply.unauthorized': 'You are not authorized to use terminal input.',
  'telegram.terminal-input.reply.expired': 'This message is too old and was not sent to the terminal.',
  'telegram.terminal-input.reply.invalid': 'Only one non-empty line of plain text can be sent.',
  'telegram.terminal-input.reply.write-failed': 'Terminal input failed and the message was not sent.',
  'telegram.terminal-input.reply.no-target': 'No focused terminal currently has control.',
  'telegram.terminal-input.reply.target-lost': 'The terminal target changed and the message was not sent.',
  'telegram.terminal-input.reply.success': 'Sent to terminal',
  'settings.telegram.master-off-hint':
    'Terminal bell notifications are off. This does not stop Telegram terminal input.',
  ...
  'settings.telegram.error.terminal-input-configuration-incomplete':
    'Terminal input requires a Bot Token, numeric group Chat ID, and at least one valid user ID.',
  ...
  'settings.group.status-refresh': 'Status refresh',
  'settings.macos-permissions.title': 'macOS system permissions',
  'settings.macos-permissions.hint': 'Required when Codex uses Computer Use from a Hobgoblin terminal.',
  'settings.macos-permissions.screen-recording': 'Screen recording',
  'settings.macos-permissions.screen-recording-hint': 'Lets Computer Use see application windows and screen content.',
  'settings.macos-permissions.accessibility': 'Accessibility',
  'settings.macos-permissions.accessibility-hint': 'Lets Computer Use click, type, and navigate in applications.',
  'settings.macos-permissions.status.not-determined': 'Not requested',
  'settings.macos-permissions.status.granted': 'Granted',
  'settings.macos-permissions.status.denied': 'Not granted',
  'settings.macos-permissions.status.restricted': 'Restricted',
  'settings.macos-permissions.status.unknown': 'Unknown',
  'settings.macos-permissions.status.unsupported': 'Unsupported',
  'settings.macos-permissions.authorize': 'Authorize',
  'settings.macos-permissions.open-system-settings': 'Open System Settings',
  'settings.macos-permissions.requesting': 'Opening…',
  'settings.macos-permissions.request-failed': 'Unable to open the macOS permission settings',
  'settings.macos-permissions.restart-hint':
    'After changing a permission, restart Hobgoblin if Computer Use still cannot see or control applications.',
  ...
  'settings.terminal.windows-external': 'External terminal',
  'settings.terminal.auto-windows': 'Automatic (WSL preferred)',
  'settings.terminal.wsl': 'WSL',
  'settings.terminal.powershell': 'PowerShell',
  'settings.terminal.cmd': 'Command Prompt',
  'settings.windows-internal-terminal-shell.title': 'Windows internal terminal',
  'settings.windows-internal-terminal-shell.label': 'Shell',
  'settings.windows-internal-terminal-shell.hint':
    "Applies to new and restarted local Windows internal terminals. This does not change the project's Git environment.",
  'settings.windows-internal-terminal-shell.auto': 'Automatic (WSL preferred)',
  'settings.windows-internal-terminal-shell.wsl': 'WSL',
  'settings.windows-internal-terminal-shell.powershell': 'PowerShell',
  'settings.windows-internal-terminal-shell.cmd': 'Command Prompt',
  ...
  'settings.apps.tool.cmd.title': 'Command Prompt',
  ...
  'settings.status-refresh': 'Scheduled change refresh',
  'settings.status-refresh-hint': 'Refreshes local change status for the active project on a schedule.',
  ...
  'help.hint': 'Shortcuts are scoped to the active view and do not run while editing text, except terminal shortcuts.',
  'help.section.nav': 'Navigation',
  'help.section.terminal': 'Terminal',
