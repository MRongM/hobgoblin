...
export const en = {
  ...
  'workspace.batch.pull-action': 'Pull all repositories',
  'workspace.batch.no-shared-base': 'No common branch is available as a base.',
  'workspace.batch.no-shared-worktree': 'No linked worktree branch exists in every repository.',
  'workspace.worktree.create-title': 'Create workspace worktree',
  'workspace.worktree.create-description':
    'Create the same branch and a linked worktree in every workspace repository.',
  'workspace.worktree.remove-title': 'Remove workspace worktree',
  'workspace.worktree.remove-description':
    'Remove the linked worktree for this branch from every workspace repository.',
  'workspace.worktree.remove-warning':
    'This removes each worktree. Selected local branches are force-deleted, so unpushed commits will be permanently lost. Upstream branches are deleted only when selected.',
  'workspace.worktree.branch-label': 'Branch name',
  'workspace.worktree.base-branch-label': 'Base branch',
  'workspace.worktree.remove-branch-label': 'Worktree branch',
  'workspace.worktree.branch-placeholder': 'feature/my-change',
  'workspace.worktree.creates-from': 'Creates from',
  'workspace.worktree.remove-linked-worktree': 'Remove linked worktree',
  'workspace.worktree.always': 'Always',
  'workspace.worktree.repositories-count': '{count} repositories',
  'workspace.worktree.pull-title': 'Pull workspace repositories',
  'workspace.worktree.pull-description': 'Fast-forward pull the current branch in every workspace repository.',
  'workspace.worktree.preview': 'Preview changes',
  'workspace.worktree.check-repositories': 'Check repositories',
  'workspace.worktree.planning': 'Checking repositories…',
  'workspace.worktree.repository': 'Repository',
  'workspace.worktree.path': 'Worktree path',
  'workspace.worktree.status': 'Status',
  'workspace.worktree.bootstrap-copy': 'Bootstrap copies {count} paths',
  'workspace.worktree.phase.ready': 'ready',
  'workspace.worktree.phase.satisfied': 'satisfied',
  'workspace.worktree.phase.succeeded': 'succeeded',
  'workspace.worktree.phase.failed': 'failed',
  'workspace.worktree.phase.not-started': 'not started',
  'workspace.worktree.cancel': 'Cancel',
  'workspace.worktree.create-confirm': 'Create in all repositories',
  'workspace.worktree.remove-confirm': 'Remove from all repositories',
  'workspace.worktree.pull-confirm': 'Pull all repositories',
  'workspace.worktree.create-success': 'Created worktrees in all repositories.',
  'workspace.worktree.remove-success': 'Removed worktrees from all repositories.',
  'workspace.worktree.pull-success': 'Pulled all repositories.',
  'workspace.worktree.batch-incomplete': 'The workspace batch operation did not complete.',
  'workspace.worktree.retry': 'Retry remaining',
  'workspace.worktree.invalid-branch': 'Enter a valid Git branch name.',
  'workspace.worktree.repository-unavailable': 'A workspace repository is unavailable.',
  'workspace.worktree.branch-exists': 'The branch already exists in a workspace repository.',
  'workspace.worktree.path-exists': 'A planned worktree path already exists.',
  'workspace.worktree.base-unavailable': 'A repository has no usable base branch.',
  'workspace.worktree.target-missing': 'A repository does not have the linked worktree.',
  'workspace.worktree.pull-target-unavailable': 'A repository has no root worktree branch to pull.',
  'workspace.worktree.remove-unsafe': 'A worktree is primary, dirty, or locked and cannot be removed.',
  'workspace.worktree.plan-stale': 'Repository state changed. Review the refreshed plan.',
  'workspace.worktree.plan-failed': 'The workspace worktree plan could not be created.',
  'workspace.worktree.execute-failed': 'The workspace worktree operation could not be completed.',
  'workspace.worktree.operation-in-progress': 'Another workspace worktree operation is already running.',
  'workspace.worktree.bootstrap-confirmation-required': 'Review and confirm repository bootstrap operations.',
