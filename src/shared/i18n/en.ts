...
export const en = {
  ...
  'workspace.repositories.collapse': 'Collapse workspace repositories',
  'workspace.repositories.expand': 'Expand workspace repositories',
  ...
  'workspace.branch-workspace.auxiliary': 'Additional files and folders',
  'workspace.branch-workspace.auxiliary-refresh': 'Refresh additional files and folders',
  'workspace.branch-workspace.auxiliary-named': 'Include additional entry {name}',
  'workspace.branch-workspace.mode-named': 'Materialization mode for {name}',
  'workspace.branch-workspace.auxiliary-empty': 'No additional root entries are available.',
  ...
  'workspace.branch-workspace.git-action.merge-back-description':
    'Merge each current branch into its recorded base branch in manifest order.',
  ...
  'workspace.branch-workspace.delete-warning':
    'Managed worktrees and this folder will be removed. External terminals cannot be detected.',
  ...
  'branch-detail.focus': 'Maximize',
  'branch-detail.focus-title': 'Maximize',
  'branch-detail.exit-focus': 'Minimize',
  'branch-detail.exit-focus-title': 'Minimize',
