...
export const en = {
  ...
  'settings.telegram.terminal-input-error.configuration-incomplete': 'Bot Token, numeric group Chat ID, or user IDs are missing.',
  ...
  'settings.telegram.terminal-input-error.webhook-conflict': 'This bot has a webhook configured, so long polling cannot start.',
