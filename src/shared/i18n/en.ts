...
export const en = {
  ...
  'tmux.host-inventory.none': 'No verified Hobgoblin tmux sessions were found on this host.',
  ...
  'tmux.host-inventory.description': 'Select the verified Hobgoblin sessions to close on this host.',
  'tmux.host-inventory.select-session': 'Select tmux session {name}',
  'tmux.host-inventory.terminal-number': 'Terminal {number}',
  'tmux.host-inventory.project-root': 'Project',
