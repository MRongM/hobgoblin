...
export const en = {
  ...
  'tmux.host-inventory.none': 'No manageable Hobgoblin tmux sessions were found on this host.',
  ...
  'tmux.host-inventory.description': 'Select the Hobgoblin sessions to close on this host.',
