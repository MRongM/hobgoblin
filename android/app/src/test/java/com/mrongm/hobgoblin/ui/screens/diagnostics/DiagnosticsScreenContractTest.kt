...
class DiagnosticsScreenContractTest {
    ...
    private fun diagnosticsScreenSource(): String {
        val candidates = listOf(
            File("src/main/java/com/mrongm/hobgoblin/ui/screens/diagnostics/DiagnosticsScreen.kt"),
            File("app/src/main/java/com/mrongm/hobgoblin/ui/screens/diagnostics/DiagnosticsScreen.kt"),
            File("android/app/src/main/java/com/mrongm/hobgoblin/ui/screens/diagnostics/DiagnosticsScreen.kt"),
        )
